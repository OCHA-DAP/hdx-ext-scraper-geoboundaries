...
class TestGeoBoundaries:
    ...
    def configuration(self):
        ...
        tags = ("administrative boundaries-divisions", "geodata", "gazetteer")
    ...
    def test_generate_dataset(self, configuration):
        ...
        assert dataset == {
            ...
            "dataset_source": "ArcGIS "
                              "HubGeoBoundariesgeoBoundarieshttps//esoc.princeton.edu/data/administrative-boundaries-398-districtshttps//hub.arcgis.com/datasets/2b63527870ef416bacf83bcaf388685f_0?geometry=53.805%2C30.812%2C81.556%2C37.181https//hub.arcgis.com/datasets/2b63527870ef416bacf83bcaf388685f_0?geometry=53.805%2C30.812%2C81.556%2C37.181",
        }
        ...
        assert resources == [
            ...
            {"description": "Other formats including shape file ADM0 boundaries for "
                            "Afghanistan",
             "format": "shp",
            ...
            {"description": "Other formats including shape file ADM1 boundaries for "
                            "Afghanistan",
             "format": "shp",
            ...
            {"description": "Other formats including shape file ADM2 boundaries for "
                            "Afghanistan",
             "format": "shp",
